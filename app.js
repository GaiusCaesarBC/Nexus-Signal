...
app.post('/api/stripe/webhook',
    ...
    createBillingWebhook({ stripe, User, Event: require('./models/StripeWebhookEvent'),
        connection: mongoose.connection, safety,
        syncRole: id => require('./services/discordService').syncPremiumRole(id) })
);
