...
class ScreenerService {
    ...
    async screenCrypto(filters = {}) {
        ...
        try {
            ...
            console.log(`[Screener] Combined crypto results: ${results.length} tokens (${pancakeSwapData.length} from PancakeSwap, ${coinGeckoData.length} from CoinGecko)`);
    ...
    async fetchPancakeSwapData(filters = {}) {
        try {
            console.log('[Screener] Fetching PancakeSwap data with filters:', filters);
            ...
            console.log(`[Screener] PancakeSwap returned ${tokens.length} tokens`);
